...
## Contributing to `andino_integration_tests`

The following is a set of guidelines for contributing to `andino_integration_tests` project.
...
* **Which version of `andino_integration_tests` are you using?**?
* **What's the name and version of the OS you're using**?
* **Are you running `andino_integration_tests` using the provided docker container?** See [docker](docker/README.md).
* **Are you running `andino_integration_tests` in a virtual machine?** If so, which VM software are you using and which operating systems and versions are used for the host and the guest?
...
* **Perform a** [cursory search](https://github.com/Ekumen-OS/andino_integration_tests/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
...
* **Specify which version of `andino_integration_tests` you're using.**
...
#. **Fork the `andino_integration_tests` package** you want to contribute to. This will create
...
All `andino_integration_tests` team members actively:

* **Watch** all `andino_integration_tests`-related repositories to receive email notifications of new issues / pull requests
